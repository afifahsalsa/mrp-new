        ...
        <div class="row flex-grow">
            <div class="col-lg-4 mx-auto">
                <div class="auth-form-light text-left p-5">
                    ...
                    <h6 class="font-weight-light text-center">Enter your details to create an account.</h6>
                    <form class="pt-3" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group">
                            <input type="password" class="form-control form-control-lg"
                                name="password_confirmation" required autocomplete="new-password" id="password-confirm" placeholder="Confirmation password">
                        </div>
                        {{-- <div class="mb-4">
